...
const ListPagination: FC = () => {
  ...
  return (
    <div className="list-pagination">
      <Pagination  current={page} onChange={(e) => setPage(e)}  showLessItems={true} responsive={false}
        showSizeChanger={false} itemRender={itemRender} defaultCurrent={1} defaultPageSize={page}
        pageSize={pageSize}  total={500}
      />
      <TreeSelect virtual className="list-pagination__pages" showSearch={false} value={pageSize}
        dropdownStyle={{ maxHeight: 400, overflow: "auto" }} placeholder="10" treeDefaultExpandAll
        onChange={(e) => setPageSize(e)}
      >
        <TreeNode value="10" title="10" />
        <TreeNode value="50" title="50" />
        <TreeNode value="100" title="100" />
